            ...
            <div className='container-fluid'>
              ...
              <div className='row'>
                <div className='col-md-6'>
                  <div className='card'>
                    <div className='card-body'>
                      <h4 className='card-title mb-0'>Recent Posts</h4>
                    </div>
                ...
                <div className='col-md-6'>
                  ...
                  <div className='card'>
                    <div className='card-body'>
                      <h4 className='card-title'>Progress Box</h4>
                      <div className='mt-3'>
              ...
              <div className='row'>
                <div className='col-md-4'>
                  <div className='card'>
                    <div className='card-body'>
                      <h5 className='card-title mb-0'>Browesr statistics</h5>
                    </div>
                    <table className='table'>
                      <thead>
                        <tr>
                ...
                <div className='col-md-4'>
                  <div className='card'>
                    <div className='card-body'>
                      <h5 className='card-title mb-0'>Website statistics</h5>
                    </div>
                    <table className='table'>
                      <thead>
                        <tr>
                ...
                <div className='col-md-4'>
                  <div className='card'>
                    <div className='card-body'>
                      <h5 className='card-title mb-0'>Visited Pages</h5>
                    </div>
                    <table className='table'>
                      <thead>
                        <tr>
